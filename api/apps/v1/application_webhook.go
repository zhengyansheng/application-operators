...
// +kubebuilder:webhook:path=/mutate-apps-vk-io--owner-v1-application,mutating=true,failurePolicy=fail,sideEffects=None,groups=apps.vk.io--owner,resources=applications,verbs=create;update,versions=v1,name=mapplication.kb.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-apps-vk-io--owner-v1-application,mutating=false,failurePolicy=fail,sideEffects=None,groups=apps.vk.io--owner,resources=applications,verbs=create;update,versions=v1,name=vapplication.kb.io,admissionReviewVersions=v1
